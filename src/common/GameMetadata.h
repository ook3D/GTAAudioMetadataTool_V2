...
namespace AMT
{
    ...
    <
        ...
        FieldType<uint16_t, "Hardness">,
        FieldType<uint8_t, "MaxImpulseMag">,
        FieldType<uint8_t, "MaxScrapeSpeed">,
        FieldType<uint16_t, "Unk03">,
        FieldType<uint8_t, "Unk04">,
        FieldType<JoaatHash, "FootstepSettings">,
        FieldType<uint8_t, "FootstepScaling">,
        FieldType<uint8_t, "ScuffstepScaling">,
    ...
    class gamePed : public SimpleBaseMetadataType
        ...
        FieldType<ArrayWrapper<gamePed_VoiceGroupItem, uint8_t>, "GangVoiceGroups">
        >
    {
    public:
    ...
    <
        ...
        FieldType<float, "unk1">,
        FieldType<float, "unk2">,
        ...
        FieldType<float, "unk9">,
        FieldType<float, "unk10">,
        FieldType<int32_t, "unk11">,
        FieldType<int32_t, "unk12">,
        FieldType<float, "unk13">,
        FieldType<float, "unk14">,
        FieldType<int32_t, "unk15">, // Some kind of engine or exhaust submix
        FieldType<int32_t, "unk16">, // Some kind of engine or exhaust submix
        FieldType<int32_t, "unk17">,
        FieldType<float, "unk18">,
        FieldType<float, "unk19">,
        FieldType<int32_t, "unk20">,
        FieldType<int32_t, "unk21">,
        FieldType<JoaatHash, "engineWaveShape">,
        FieldType<uint32_t, "unk22">,
        FieldType<JoaatHash, "exhaustWaveShape">,
        FieldType<uint32_t, "unk23">,
        FieldType<int32_t, "MinPitch">,
        FieldType<int32_t, "MaxPitch">,
        ...
        FieldType<int32_t, "TransWhineMinPitch">,
        FieldType<int32_t, "TransWhineMaxPitch">,
        ...
        FieldType<float, "BrakeSqueekFactor">,
        ...
        FieldType<int32_t, "GearTransMinPitch">,
        FieldType<int32_t, "GearTransMaxPitch">,
        FieldType<int32_t, "GTThrottleVol">,
        FieldType<int32_t, "DumpValveProb">,
