...
namespace AMT
{
    ...
    void RegisterGameSchema(std::map<std::string, MetadataFileDef>& registry)
    {
        ...
        def.types[1] = {1, "gameCollision", {
            ...
            UInt16("ImpulseMagScalar"), 
            UInt8("BulletCollisionScaling"),
        ...
        def.types[0] = {0, "gameAutomobile", {
            ...
            Hash("revsOffLoop"),
            Float("EngineAccelVolume"), 
            Float("ExhaustAccelVolume"), 
            Int32("EngineAccelMinPitch"), 
            Int32("EngineAccelMaxPitch"),
            Float("EngineDecelVolume"), 
            Float("ExhaustDecelVolume"), 
            Int32("EngineDecelMinPitch"), 
            Int32("EngineDecelMaxPitch"),
            Float("EngineIdleVolume"), 
            Float("ExhaustIdleVolume"), 
            Int32("EngineIdleMinPitch"), 
            Int32("EngineIdleMaxPitch"),
            Float("EngineRevsVolume"), 
            Float("ExhaustRevsVolume"),
            Int32("EngineRevsMinPitch"), 
            Int32("EngineRevsMaxPitch"), 
            Int32("ThrottleResonanceVolume"),
            Float("Filter1Cutoff"), 
            Float("Filter2Cutoff"), 
            Int32("ResonanceMinPitch"), 
            Int32("ResonanceMaxPitch"),
            Hash("EngineSynthDef"), 
            Int32("EngineWaveShapePitch"),
            Hash("ExhaustSynthDef"), 
            Int32("ExhaustWaveShapePitch"),
            Int32("MinPitch"), 
            Int32("MaxPitch"),
